        ...
        <div className="max-w-[1400px] mx-auto pt-10 pb-24 px-4 sm:px-6 lg:px-8">
          ...
          {products.length > 0 ? (
            ...
            <div className="py-24 text-center border border-dashed border-white/10">
              ...
              <Link
                href="/"
                className="mt-6 inline-flex h-10 items-center justify-center bg-white/5 text-white px-6 text-[11px] uppercase font-bold tracking-widest hover:bg-white/10 transition-colors"
              >
                Return Home
              </Link>
            </div>
