export function ScrollingText() {
  ...
  return (
    <div className="bg-black overflow-hidden whitespace-nowrap py-3 border-y border-white/10 light:bg-white light:border-black/10 light:text-black select-none ">
